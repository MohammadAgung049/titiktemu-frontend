...
// Import Icon: FaPaperPlane untuk 'Send', FaKey untuk 'OTP'
import { FaPhone, FaKey, FaPaperPlane } from 'react-icons/fa6';
...
const ForgotPassword = () => {
  ...
  const handleKirimOtp = () => {
    alert("Kode OTP telah dikirim ke WhatsApp Anda! (Simulasi)");
  };
  ...
  return (
    <div style={styles.container}>
      ...
      {/* --- 2. WAVE DECORATION (Tetap konsisten) --- */}
      ...
      <main style={styles.mainContent}>
        <div style={styles.formCard}>
          ...
          <p style={styles.subtitle}>Masukkan nomor ponsel untuk menerima kode OTP</p>

          <form style={styles.form}>
            
            {/* 1. Input No Ponsel + Tombol Kirim OTP */}
            <div style={styles.inputGroup}>
              ...
              <input 
                ...
                style={styles.inputFieldWithAction} // Style khusus supaya teks tidak nabrak tombol
              />
              {/* Tombol Kirim OTP di dalam input */}
              <button 
                type="button"
                onClick={handleKirimOtp}
                style={styles.btnActionInside}
              >
                <span>Kirim OTP</span>
            ...
            {/* Tombol Verifikasi */}
            <button type="button" style={styles.btnLogin}>
              Verifikasi
            </button>
          </form>
          ...
          <div style={styles.footerText}>
            sudah ingat password? <span style={styles.linkRegister} onClick={() => navigate('/login')}>masuk disini</span>
          </div>
...
const styles = {
  ...
  formCard: {
    width: '100%',
    maxWidth: '500px', // Sedikit lebih ramping dibanding Register
    textAlign: 'center'
  },
  title: {
    fontSize: '2rem',
  ...
  // Input dengan Tombol Action (Kirim OTP) di dalamnya
  inputFieldWithAction: {
    width: '100%',
    padding: '14px 110px 14px 48px', // Padding kanan besar supaya teks tidak ketabrak tombol
    backgroundColor: '#E0E0E0',
    color: '#1F2937',
    borderRadius: '10px',
    border: 'none',
  ...
  // Tombol Kirim OTP di dalam input (Posisi Kanan)
  btnActionInside: {
    position: 'absolute',
    top: '50%',
    right: '8px',
    ...
    alignItems: 'center',
    gap: '6px',
    backgroundColor: '#0077B6', // Warna biru cerah
    color: 'white',
    border: 'none',
    borderRadius: '6px',
    padding: '6px 10px',
